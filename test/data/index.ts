...
export const figmaDoc: DocumentResponse = JSON.parse(readFileSync("./test/data/figmaDoc.json").toString());
...
export const categoryNames = categoryNodes.map((category) => category.name.toLowerCase().replace(`\g `, "_"));
