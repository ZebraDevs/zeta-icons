...
describe("parseFilesChange test", () => {
  it("should return icon changes correctly", () => {
    ...
    expect(output.trim()).to.equal(
      `<h2> Icons added: <ul><li>Maps / Mr Worldwide / Round</li><li>Maps / Mr Worldwide / Sharp</li></ul> </h2><h2> Icons updated: <ul><li>File / Ppt Attach / Round</li><li>File / Ppt Attach / Sharp</li></ul> </h2><h2> Icons deleted: <ul><li>Maps / Place Maps / Round</li><li>Maps / Place Maps / Sharp</li></ul> </h2>
`.trim(),
    );
  });
});
