 ...
 */
export declare function generateIconManifest(categoryNodes: FigmaNode[], componentSets: ComponentSets, iconOutputDir: string, verboseLogs: boolean): IconManifest;
